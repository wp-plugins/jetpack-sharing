...
<?php
	...
	public function management_page() {
		...
		if( !isset( $global['sharing_label'] ) || '' == $global['sharing_label']  ) {
			$global['sharing_label'] = __( 'Share this:', 'jetpack-sharing' );
		}
?>
	  		...
	  		<table id="available-services">
					<tr>
		  			<td class="description">
		  				...
		  				<p><a href="#TB_inline?height=395&amp;width=600&amp;inlineId=new-service" class="thickbox" id="add-a-new-service"><?php _e( 'Add a new service', 'jetpack-sharing' ); ?></a></p>
		  			</td>
		  			<td class="services">
